#Crea una función llamada calcular_descuento que tome dos parámetros: el monto total de
#la compra y un valor predeterminado para el porcentaje de descuento
